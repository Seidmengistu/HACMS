...
function mt(t) {
	var e, i, n, a, o, r, s = t._i,
		l = ea.exec(s) || ia.exec(s);
	if (l) {
		for (u(t).iso = !0, e = 0, i = aa.length; i > e; e++)
			if (aa[e][1].exec(l[1])) {
				a = aa[e][0], n = aa[e][2] !== !1;
				break
			} if (null == a) return void(t._isValid = !1);
		if (l[3]) {
			for (e = 0, i = oa.length; i > e; e++)
				if (oa[e][1].exec(l[3])) {
					o = (l[2] || " ") + oa[e][0];
					break
...
function Wt(t) {
	var e = t._i,
		i = t._f;
	return t._locale = t._locale || W(t._l), null === e || void 0 === i && "" === e ? f({
		nullInput: !0
	}) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), b(e) ? new p(gt(e)) : (a(i) ? It(t) : i ? At(t) : o(e) ? t._d = e : Vt(t), c(t) || (t._d = null), t))
}
...
function ri(t, e, i) {
	...
	if (!this._weekdaysParse)
		for (this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], n = 0; 7 > n; ++n) o = h([2e3, 1]).day(n), this._minWeekdaysParse[n] = this.weekdaysMin(o, "").toLocaleLowerCase(), this._shortWeekdaysParse[n] = this.weekdaysShort(o, "").toLocaleLowerCase(), this._weekdaysParse[n] = this.weekdays(o, "").toLocaleLowerCase();
...
function qi() {
	var t, e, i, n, a, o = this._milliseconds,
		r = this._days,
		s = this._months,
		l = this._data;
...
function an(t, e, i) {
	var n = oe(t).abs(),
		...
		l = io(n.as("M")),
		h = io(n.as("y")),
		d = a < no.s && ["s", a] || 1 >= o && ["m"] || o < no.m && ["mm", o] || 1 >= r && ["h"] || r < no.h && ["hh", r] || 1 >= s && ["d"] || s < no.d && ["dd", s] || 1 >= l && ["M"] || l < no.M && ["MM", l] || 1 >= h && ["y"] || ["yy", h];
...
function sn() {
	var t, e, i, n = ao(this._milliseconds) / 1e3,
		a = ao(this._days),
		o = ao(this._months);
...
var gn, mn, pn = {},
	bn = {},
	vn = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,
...
var Xn = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
	Qn = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
