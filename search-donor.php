...
<body>
    ...
    <div class="container"style="background-image:url('includes/images/blood-donor.jpg')" >
        ...
        <h1 style="color:blue" class="mt-4 mb-3">Search <small>Donor</small></h1>
        ...
        <form name="donar" method="post">
            ...
            <?php 
                        ...
                        $sql = "SELECT * from becomedonor where (status=:status and BloodGroup=:bloodgroup) ||  (Address=:location)";
                        $query = $dbh -> prepare($sql);
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-block">
                        ...
                        <p class="card-text"><b>Mobile No. / Email Id :</b>
                    ...
                    {
                        $_SESSION['status']="No Record Found With This Blood Group";
