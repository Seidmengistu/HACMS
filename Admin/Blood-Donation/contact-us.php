...
<body class="nav-md">
	<div class="container body">
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								<a class="btn btn-danger" href="login.php"><i></i> Log Out</a>
				</div>
				</li>
		...
		<div class="right_col" style="background-image:url('../includes/images/blood-donor.jpg')" role="main" style="">
			...
			<h3 style="color:blue;font-family:new times roman;text-align:center;font-size:30px">Contact-Us
				</h3>
			<ul style="background-color:pink">
				<li style="background-color:pink;color:green;font-family:new times roman;font-size:30px">
					<strong>Phone:</strong>0968983297</li>
				<li style="background-color:pink;color:green;font-family:new times roman;font-size:30px">
					<strong>Email:</strong>seidmengistu88@gmail.com  </li>
